# -*- coding: utf-8 -*-
"""Reading Empatica Data.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1dMR6eWANzzjGTTlB-84UCgBa1OiXD9c4
"""
    ...
    with open(file, 'r') as csvfile:
        ...
        for row in reader:
            if(i == 0):
                ...
                print("Initial Timestamp:  "+ str(initialTimestamp)+" exact Time: "+convertMilisToTime(initialTimestamp))
            else:
...
ACC = {}
ACC = readAccFile('ACC.csv')

HR = {}
HR = readFile('HR.csv')

EDA = {}
EDA = readFile('EDA.csv')

BVP = {}
BVP = readFile('BVP.csv')

TEMP = {}
TEMP = readFile('TEMP.csv')

IBI = {}
IBI = readIBI_File('IBI.csv')
...
with open(outputFile,'w') as f1:
    ...
    for timestampHR, hr in HR.items():
        ...
        if(count > 0):
            meanEDA = total/count
        print("Merging HRV and EDA at: "+ str(timestamp)+ " HRV: "+str(hr)+" EDA: "+str(meanEDA)+ " count: "+str(count))
        #merging with BVP
        i = 0.0
        total = 0.0
        count = 0
        ...
        #print("Merging HRV and TEM at "+ timestamp+ " HRV: "+str(hr)+" TEM: "+str(meanTEMP)+ " count: "+count )
        #merging with ACC
        i = 0.0
        totalX = 0.0
        totalY = 0.0
...
import pandas as pd
input_file='mergedBioData.csv'
data = pd.read_csv(input_file)
data= data.drop(['SumIBI', 'Beats'], axis=1)
print(data)

# Exclude datetime column
data_values = data.drop(['Timestamp','ID','Hour'],axis=1).values
